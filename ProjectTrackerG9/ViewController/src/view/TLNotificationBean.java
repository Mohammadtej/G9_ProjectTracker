...
public class TLNotificationBean {
    
    private List<Notification> notifications;

    public TLNotificationBean() {
    ...
    public String fetchNotification() {
        ...
        DCIteratorBinding iteratorBinding = bindings.findIteratorBinding("ModuleForPlIterator");
        ...
        if (iteratorBinding != null) {
            ...
            BigDecimal docName = (BigDecimal)currentRow.getAttribute("ModuleId");
            ...
            do {
                ...
                // Access row attributes (replace 'AttributeName' with actual attribute names)
                docName = (BigDecimal)currentRow.getAttribute("ModuleId");
